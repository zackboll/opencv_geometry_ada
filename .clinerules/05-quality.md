...
The public `opencv_geometry` crate must not acquire testing, proof, coverage,
...
7. complete the validation-boundary review when `cpp/opencv_geometry_shim.cpp` changed
